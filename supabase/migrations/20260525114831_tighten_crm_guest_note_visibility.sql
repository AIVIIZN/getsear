-- 20260525114831_tighten_crm_guest_note_visibility.sql
-- Task: CRM-V1.1 - enforce guest note visibility levels
-- One-way migration; rollback in supabase/_rollbacks/20260525114831_tighten_crm_guest_note_visibility.rollback.sql
