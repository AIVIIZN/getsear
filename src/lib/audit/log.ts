...
export type AuditAction =
  ...
  | 'crm_integration_connection_saved'
  | 'crm_health_scan_run'
  | 'crm_health_issue_reviewed'
  | 'crm_health_issue_resolved'
  | 'crm_health_issue_dismissed'
  ...
  | 'crm_report_created'
  | 'crm_dashboard_created'
  | 'crm_report_previewed'
  | 'crm_report_run_started'
  | 'crm_ai_gateway_invoked'
  | 'crm_ai_gateway_refused'
  | 'crm_restaurant_memory_seeded'
  | 'crm_restaurant_memory_updated'
  | 'crm_survey_created'
...
export type EntityType =
  ...
  | 'crm_report_run'
  | 'crm_ai_audit_log'
  | 'crm_ai_prompt_template'
  | 'crm_ai_tool_call'
  | 'restaurant_memory_rule'
  | 'crm_survey'
  | 'crm_survey_response'
  | 'crm_review'
  | 'crm_complaint'
