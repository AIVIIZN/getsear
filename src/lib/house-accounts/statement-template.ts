...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 800px; margin: 0 auto; padding: 40px; color: #1a1a1a;">
  <!-- Header -->
  <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 40px; border-bottom: 3px solid #F06B18; padding-bottom: 24px;">
    <div>
      <h1 style="font-size: 24px; font-weight: 700; margin: 0;">ACCOUNT STATEMENT</h1>
      <p style="font-size: 14px; color: #F06B18; margin: 4px 0 0; font-weight: 500;">${data.restaurant_name}</p>
  ...
  <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 32px; margin-bottom: 32px;">
    ...
    <div style="text-align: right;">
      <div style="padding: 16px; background: #1a1a1a; border-radius: 12px; color: #fff; display: inline-block;">
        ...
        <p style="font-size: 28px; font-weight: 700; margin: 4px 0 0; color: #F06B18;">$${data.ending_balance.toFixed(2)}</p>
