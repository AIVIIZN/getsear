...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 800px; margin: 0 auto; padding: 40px; color: #1a1a1a;">
  ...
  <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 40px;">
    <div>
      <h1 style="font-size: 28px; font-weight: 700; color: #007AFF; margin: 0;">INVOICE</h1>
  ...
  <div style="display: flex; justify-content: flex-end;">
    <table style="width: 280px; font-size: 14px;">
      ...
      <tr style="border-top: 2px solid #007AFF;">
        <td style="padding: 8px 0; font-weight: 700; color: #007AFF;">Balance Due</td>
        <td style="text-align: right; font-weight: 700; font-size: 18px; color: #007AFF;">$${data.balance_due.toFixed(2)}</td>
      </tr>
    </table>
  </div>
