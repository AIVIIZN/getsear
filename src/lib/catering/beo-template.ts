  ...
  const menuHtml = data.menu_selections
    .map(
      ...
      <div style="margin-bottom: 16px;">
        <h3 style="font-size: 14px; font-weight: 600; color: #007AFF; margin-bottom: 8px; text-transform: uppercase; letter-spacing: 1px;">
          ${course.course}
        </h3>
        ${course.items
          .map(
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 800px; margin: 0 auto; padding: 32px; color: #1a1a1a;">
  <!-- Header -->
  <div style="text-align: center; margin-bottom: 32px; border-bottom: 3px solid #007AFF; padding-bottom: 24px;">
    <h1 style="font-size: 28px; font-weight: 700; margin: 0; color: #007AFF;">BANQUET EVENT ORDER</h1>
