...
/**
 * GET /api/reports/voids-comps — void, comp, and discount analysis
 * Query params: date_from, date_to, location_id, employee_id
 */
export async function GET(request: NextRequest) {
  ...
  const result = await getVoidCompData(user.org_id, dateFrom, dateTo, locationId, employeeId)
