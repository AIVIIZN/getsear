...
export default function PosError({
  ...
  useEffect(() => {
    captureRouteGroupError(error, 'pos')
  }, [error])
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-surface-primary p-6">
      <div className="w-full max-w-md rounded-2xl border border-border bg-card p-8 text-center shadow-warm-lg">
        ...
        <h2 className="page-title mb-3 text-xl">Register needs a quick reload</h2>
        <p className="mb-6 text-sm text-text-secondary">
          Your current order state is protected. Reload this register view and continue service.
        </p>
        <button
          onClick={reset}
