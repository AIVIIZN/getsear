...
import { getMockDailySales, type DailySalesPoint } from '@/lib/reports/mock-data'
...
export default function SalesReportPage() {
  const [data, setData] = useState<DailySalesPoint[]>(getMockDailySales(7))
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-2 text-sm">
        ...
        <span className={trend >= 0 ? 'text-[var(--success)]' : 'text-[var(--error)]'}>
        ...
        <CardContent>
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody>
                {data.map((row) => (
                  <tr key={row.date} className="border-b border-[var(--border)] last:border-b-0 hover:bg-[var(--secondary)]">
