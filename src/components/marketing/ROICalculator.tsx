    ...
    >
      ...
      >
        ...
        <div className="mt-16 grid gap-10 lg:grid-cols-2">
          {/* Inputs */}
          <div className="space-y-8 rounded-2xl border border-[rgba(60,60,67,0.08)] bg-[var(--color-marketing-bg)] p-8">
            ...
            <div>
              <div className="flex items-center justify-between">
                <label className="text-[15px] font-medium text-[var(--color-marketing-text)]">
                  Monthly card volume
                </label>
              ...
              <input
                ...
                className="mt-3 h-2 w-full cursor-pointer appearance-none rounded-full bg-[var(--color-marketing-bg-soft)] accent-[var(--color-primary)] [&::-webkit-slider-thumb]:h-5 [&::-webkit-slider-thumb]:w-5 [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-[var(--color-primary)] [&::-webkit-slider-thumb]:shadow-md"
              />
              <div className="mt-1 flex justify-between text-[12px] text-[var(--color-marketing-text-muted)]">
                <span>$10K</span>
                <span>$200K</span>
              </div>
            </div>
          ...
          <div className="flex flex-col justify-between">
            {/* Savings card */}
            <div className="rounded-2xl bg-gradient-to-br from-[var(--color-text)] to-[var(--color-bg-muted)] p-8 text-white">
              <div className="flex items-center gap-2">
                <TrendingUp size={20} className="text-[var(--color-success-strong)]" />
                <span className="text-[15px] font-medium text-[var(--color-neutral-350)]">
                  Your estimated savings with Sear
                </span>
              </div>

              <div className="mt-6">
                <span className="text-[56px] font-bold tracking-tight tabular-nums text-[var(--color-primary)] md:text-[64px]">
                  {formatCurrency(animatedMonthly)}
                </span>
                <span className="ml-2 text-[18px] text-[var(--color-neutral-350)]">
                  per month
                </span>
              </div>
              ...
              <div className="mt-2">
                ...
                <span className="ml-2 text-[15px] text-[var(--color-neutral-350)]">
                  per year
                </span>
              </div>

              <div className="mt-8 space-y-3 border-t border-white/10 pt-6">
                <h4 className="text-[14px] font-medium text-[var(--color-neutral-350)]">
                  Savings breakdown
                </h4>
                <div className="flex justify-between">
                  <span className="text-[14px] text-[var(--color-neutral-350)]">
                    Processing fee savings (dual pricing)
                  </span>
                  <span className="text-[14px] font-semibold tabular-nums text-[var(--color-success-strong)]">
            ...
            <div className="mt-6 rounded-2xl border border-[rgba(60,60,67,0.08)] bg-white p-6">
              <h4 className="text-[15px] font-semibold text-[var(--color-text)]">
                With Sear, you pay:
              </h4>
              <div className="mt-3 space-y-2">
                <div className="flex justify-between text-[14px]">
                  <span className="text-[var(--color-marketing-text-muted)]">
                ...
                <div className="flex justify-between text-[14px]">
                  ...
                  <span className="font-medium text-[var(--color-success-strong)]">$0/mo*</span>
                </div>
                <div className="flex justify-between text-[14px]">
                  <span className="text-[var(--color-marketing-text-muted)]">
                    Hardware (BYOD iPad)
