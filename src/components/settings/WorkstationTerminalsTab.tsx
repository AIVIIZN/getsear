...
export function WorkstationTerminalsTab() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-base font-semibold text-foreground">Workstations</h2>
          <p className="text-sm text-muted-foreground">
            {terminals.length} workstation{terminals.length !== 1 ? "s" : ""} registered
          </p>
        </div>
        <Button
      ...
      {terminals.length === 0 ? (
        ...
        <Card className="shadow-warm-sm">
          <CardHeader>
            <CardTitle className="sr-only">Workstations table</CardTitle>
          </CardHeader>
